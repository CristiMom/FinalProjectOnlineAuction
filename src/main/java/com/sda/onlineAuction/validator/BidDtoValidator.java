...
public class BidDtoValidator {
    ...
    public void validate(BidDto bidDto, BindingResult bindingResult, String productId) {
        ...
        // 4 - sa fie mai mare ca cel mai mare bid existent - in cazul in care exista bid-uri
        ...
        if  (product.getStartingPrice() > bidValueAsNumber){
            FieldError fieldError = new FieldError("bidDto", "value", "Value must be a least starting price");
            bindingResult.addError(fieldError);
            return;
        }
